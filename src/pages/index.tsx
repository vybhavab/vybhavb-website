        ...
        <Container maxW={'container.lg'}>
            ...
            <Text fontSize={{base: 'sm', sm: "sm",md:"lg", lg:'xl'}} display={{md:'none'}} color={bgTextColor}>
              tl;dr<br/>I build scaleable, fast and secure applications. Check some of them out over at&nbsp;
                ...
                If you'd like to get in contact mail me → <Link href="mailto:contact@vybhavb.com"
                  color={useColorModeValue("green.400", "green.100")}>
                    contact@vybhavb.com
                </Link>
            </Text>
            <Text fontSize={{base: 'sm', sm: "sm",md:"lg", lg:'xl'}} display={{base: 'none', md:"block"}} color={bgTextColor}>
                tl;dr<br/>I build scaleable, fast and secure applications. Check some of them out over at&nbsp;
                <Link href="/projects" color={useColorModeValue("green.400", "green.100")}>/projects</Link>&nbsp;
                Want to chat? Email me → <Link href="mailto:contact@vybhavb.com"
                  color={useColorModeValue("green.400", "green.100")}>
                    contact@vybhavb.com
                </Link> or find me anywhere @vybhavb
            </Text>
            </Stack>
        </Container>
    );
